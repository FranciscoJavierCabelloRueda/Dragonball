...
/* var_dump($datos); // Muestra los datos antes de enviarlos como JSON. Terminal: curl -i http://localhost:8080/apipersonajes/leer.php
// Si `var_dump` muestra datos pero la API sigue vacía, entonces el problema está en `echo json_encode()`
 */

// Convertir a UTF-8 cada campo del array
